            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">REGISTRAR DOCUMENTACION</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select id="inputState" class="form-control">
                                            ...
                                            <option>Personeria Juridica</option>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label></label>
                                        <input type="file" class="form-control" placeholder="Adjuntar Archivo">
                                    </div>
                                </div>
                        ...
                        <nav class="row">
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="#" class="text-reset"> <i class="fab fa-instagram"></i> Nombre de
                                            Usaurio</a></li>
                                    <li><a href="#" class="text-reset"><i class="fab fa-facebook-f"></i> Nombre de
                                            Usuario</a></li>
                                    <li><a href="#" class="text-reset"><i class="fab fa-twitter"></i> Nombre de
                                            Usuario</a></li>
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-6">
                                <ul class="list-unstyled">
                                    ...
                                    <p>​Somos una historia de trabajo y esfuerzo continuo que año tras año nos va
                                        reforzando gracias al apoyo de nuestros proveedores y fidelidad de nuestros
                                        clientes.
                                        La misión, visión y valores de Isaac Lema están dirigidos a satisfacer las
